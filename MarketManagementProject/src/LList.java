...
public class LList<T> implements IList<T>
{
    ...
    public void add(T newEntry)
    {
        ...
        if (isEmpty()) {
            // If the list is empty, both firstNode and lastNode should reference the new node
            firstNode = newNode;
            lastNode = newNode;
        } else {
            // If the list is not empty, add the new node to the end and update lastNode
